...
export default () => {
    ...
    const ButtonLeft = Button(world, "blue", { x: Constants.WINDOW_WIDTH / 2 - 150, y: Constants.WINDOW_HEIGHT - 50 }, { width: 80, height: 50 }, "left", () => MoveObject("left", Player));
    const ButtonRight = Button(world, "blue", { x: Constants.WINDOW_WIDTH / 2 + 150, y: Constants.WINDOW_HEIGHT - 50 }, { width: 80, height: 50 }, "right", () => MoveObject("right", Player));
    const JumpButton = Button(world, "blue", { x: Constants.WINDOW_WIDTH / 2, y: Constants.WINDOW_HEIGHT - 50 }, { width: 130, height: 50 }, "jump", () => MoveObject("jump", Player));
